...
function cdf( x, options ) {
	...
	opts.c = typeof opts.c !== 'undefined' ? opts.c : 0.5;

	if ( isNumber( x ) ) {
		return cdf1( x, opts.a, opts.b, opts.c );
	}
	if ( isMatrixLike( x ) ) {
		if ( opts.copy !== false ) {
		...
		return cdf5( out, x, opts.a, opts.b, opts.c );
	}
	if ( isTypedArrayLike( x ) ) {
		...
		return cdf6( out, x, opts.a, opts.b, opts.c );
	}
	if ( isArrayLike( x ) ) {
		// Handle deepset first...
		if ( opts.path ) {
			opts.sep = opts.sep || '.';
			return cdf4( x, opts.a, opts.b, opts.c, opts.path, opts.sep );
		}
		...
		if ( opts.accessor ) {
			return cdf3( out, x, opts.a, opts.b, opts.c, opts.accessor );
		}
		return cdf2( out, x, opts.a, opts.b, opts.c );
	}
	return NaN;
} // end FUNCTION cdf()
